Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                   ...
                   DESC
  spec.homepage     = "https://github.com/gabrieltheodoropoulos/GTAlertCollection"
  ...
  spec.source       = { :git => "https://github.com/gabrieltheodoropoulos/GTAlertCollection", :tag => "1.0.0" }
